...
$optunaEntry = "dca_bot.scripts.optuna"       # `python -m …`
...
$coins = @(
    ...
    @{ Symbol = "SOLUSDT"; Start = "2020-09-03"; End = "2025-06-20" },
    @{ Symbol = "ETHUSDT"; Start = "2017-01-22"; End = "2025-06-20" },
    @{ Symbol = "SUIUSDT"; Start = "2023-07-01"; End = "2025-06-20" },
    @{ Symbol = "WIFUSDT"; Start = "2023-11-23"; End = "2025-06-20" },
    @{ Symbol = "PEPEUSDT"; Start = "2023-04-25"; End = "2025-06-20" },
    @{ Symbol = "1INCHUSDT"; Start = "2022-05-30"; End = "2025-06-20" },
    @{ Symbol = "BTCUSDT"; Start = "2018-01-01"; End = "2025-06-20" },
    @{ Symbol = "XLMUSDT"; Start = "2020-05-01"; End = "2025-06-24" }
)
